...
@Component({
  selector: 'app-elegir-actualizar',
  imports: [CommonModule, RouterModule],
  templateUrl: './elegir-actualizar.component.html',
  styleUrl: './elegir-actualizar.component.css'
})
export class ElegirActualizarComponent {
